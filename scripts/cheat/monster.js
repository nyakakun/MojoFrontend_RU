...
function genMonster() {
    ...
    <h2>Спавн сущности</h2>
            <label for="entity-search">Имя сущности:</label>
                <div style="display: flex; flex-direction: column;">
                    <div style="display: flex; align-items: center; overflow: hidden;">
                        <input id="entity-search" style="flex: 4" type="text" placeholder="Поиск сущности по имени" />
            ...
            <label for="amount">Уровень(Только для монстров):</label><input type="number" id="level" name="level" value=10 />
            <input type="hidden" id="entity-id" />
            <button disabled id="execute">Заспавнить</button>
    </div>`;
    updateEntityList();
