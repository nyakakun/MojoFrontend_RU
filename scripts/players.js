...
async function displayUserList() {
    ...
    for (const player of players) {
        ...
        buttons.innerHTML = `<button class="kickButton" onclick="kickUser('${player}')">Выкинуть</button>`;
        buttons.innerHTML += `<button class="banButton" onclick="banUser('${player}')">Забанить</button>`;
